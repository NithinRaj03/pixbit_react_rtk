...
const Edit = () => {
  ...
  const FORM_VALIDATION = Yup.object().shape({
    ...
    landline: Yup.string()
      .matches(phoneRegExp, "Landline number is not valid")
      .nullable(),
    join_date: Yup.date()
      .nullable()
  ...
  const [updateEmloyee, { isSuccess, error }] = useUpdateEmployeeMutation();
              ...
              <Grid container>
                <Grid item xs={12}>
                  <TextField
                    ...
                    name="first_name"
                    label="First Name"
                    errorMessage={error.data.errors.first_name}
                  />
                  <TextField
                    className={classes.text_field}
                    name="last_name"
                    label="Last Name"
                    errorMessage={error.data.errors.last_name}
                  />
                  <TextField
                    className={classes.text_field}
                    name="email"
                    label="Email"
                    errorMessage={error.data.errors.email}
                  />
                  <TextField
                    className={classes.text_field}
                    name="mobile"
                    label="Mobile"
                    errorMessage={error.data.errors.mobile}
                  />
                  <TextField
                    className={classes.text_field}
                    name="landline"
                    label="Landline"
                    errorMessage={error.data.errors.landline}
                  />
                  <DateTime
                    className={classes.text_field}
                    name="join_date"
                    label="Joining Date"
                    errorMessage={error.data.errors.join_date}
                  />
                  <DateTime
                    className={classes.text_field}
                    name="date_of_birth"
                    label="Date of Birth"
                    errorMessage={error.data.errors.date_of_birth}
                  />
                  <Select
                    className={classes.text_field}
                    name="designation_id"
                    ...
                    errorMessage={error.data.errors.designation_id}
                  />
                  <Select
                    className={classes.text_field}
                    label="Status"
                    ...
                    errorMessage={error.data.errors.status}
                  />
                  <RadioGender
                    className={classes.gender}
                    row
                    name="gender"
                    errorMessage={error.data.errors.gender}
                  />
                  <TextField
                    className={classes.text_field}
                    ...
                    multiline
                    rows={3}
                    errorMessage={error.data.errors.present_address}
                  />
                  ...
                  <TextField
                    ...
                    multiline
                    rows={3}
                    errorMessage={error.data.errors.permanent_address}
                  />
                  <Grid
                    container
                    spacing={2}
